...
br_make1: prepare $(target/stamp-compile) $(package/stamp-cleanup) $(package/stamp-compile) $(package/stamp-install)
br_make2: $(package/stamp-rootfs-prepare) $(target/stamp-install) FORCE
