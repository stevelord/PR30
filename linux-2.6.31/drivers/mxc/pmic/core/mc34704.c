...
int __devinit pmic_init_registers(void)
{
	 ...
	 */
#if 1
	CHECK_ERROR(pmic_write(REG_MC34704_GENERAL1, 0x0C)); // 2(sec) power off
#else
	...
	CHECK_ERROR(pmic_write(REG_MC34704_REG8SET1,0x00));
	...
	CHECK_ERROR(pmic_write(REG_MC34704_REG8SET2,0x7C));
#endif
#if 1

	CHECK_ERROR(pmic_write(REG_MC34704_GENERAL2, 0x03));
#endif
...
{
	pmic_write(REG_MC34704_GENERAL2, 0x10); // ALLOFF
}
