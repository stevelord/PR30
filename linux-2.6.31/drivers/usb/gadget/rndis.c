...
/* ---- 2010/10/15  Modification ---- START */
#if defined(BR_CUSTOMIZATION_STARHUB)
#define BR_CS_VENDOR_NAME  "StarHub"
#else
#define BR_CS_VENDOR_NAME  "BandRich"
#endif
/* ---- 2010/10/15  Modification ---- END */
...
int __init rndis_init (void)
{
	...
	for (i = 0; i < RNDIS_MAX_CONFIGS; i++) {
		...
		rndis_per_dev_params [i].vendorDescr = BR_CS_VENDOR_NAME;
