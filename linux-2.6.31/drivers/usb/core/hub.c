...
#if 1
#define BR_FEATURE_USB_ENUM_FAIL_RESET_3G
#endif
...
#ifdef BR_FEATURE_USB_ENUM_FAIL_RESET_3G
extern void gpio_3g_reset( void );
#endif
...
loop:
	...
	{
#ifdef BR_FEATURE_USB_ENUM_FAIL_RESET_3G
		printk("Error:unable to enumerate 3G USB device on port %d.\nReset 3G module\n", port1 );
