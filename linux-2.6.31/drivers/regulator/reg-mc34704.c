...
/*
** Add REG8 for OLED 12V 
*/
#if 1
	{
	 .v_default = REG6_V_MV,
	 .dvs_min = REG6_DVS_MIN_PCT / 2.5,
	 .dvs_max = REG6_DVS_MAX_PCT / 2.5,
	 .i2c_dvs = 0xF,
	 .i2c_stat = 0x11,
	 .enable = MC34704_ONOFFC,
	},
	{
	 .v_default = REG7_V_MV,
	 .dvs_min = REG7_DVS_MIN_PCT / 2.5,
	 .dvs_max = REG7_DVS_MAX_PCT / 2.5,
	 .i2c_dvs = 0x12,
	 .i2c_stat = 0x14,
	 .enable = MC34704_ONOFFC,
	},
	{
	 .v_default = REG8_V_MV,
	 .dvs_min = REG8_DVS_MIN_PCT / 2.5,
	 .dvs_max = REG8_DVS_MAX_PCT / 2.5,
	 .i2c_dvs = 0x15,
	 .i2c_stat = 0x17,
	 .enable = MC34704_ONOFFD,
	},
#endif
...
*/
#if 1
	{
	 .name = "REG6_XXX",
	 .id = MC34704_REG6,
	 .ops = &mc34704_partial_ops,  // &mc34704_full_ops,
	 .irq = 0,
	 .type = REGULATOR_VOLTAGE,
	 .owner = THIS_MODULE},
	{
