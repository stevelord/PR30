...
** PMIC is in I2C2
*/
#undef CONFIG_I2C_MXC_SELECT1

#define CONFIG_I2C_MXC_SELECT2
/* ----END */   
#endif
...
/* imx adc driver */
/* Modify by Anchor */
#if defined(CONFIG_IMX_ADC) || defined(CONFIG_IMX_ADC_MODULE) || defined(CONFIG_BR_BATTERY_MONITOR) || defined(CONFIG_BR_BATTERY_MONITOR_MODULE)
...
/* Modify by Anchor */
#if defined(CONFIG_BR_CHARGE_CONTROL_SUPPORT) || defined(CONFIG_BR_CHARGE_CONTROL_SUPPORT_MODULE)
static struct platform_device BR_Charger_device = {
	.name = "BR_Charger",
	.id = 0,
	.dev = {
		.release = mxc_nop_release,
...
static inline void BR_init_Charger(void)
{
	(void)platform_device_register(&BR_Charger_device);
}
#else
static inline void BR_init_Charger(void)
{
