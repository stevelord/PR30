...
ifeq ($(strip $(CONFIG_EXTERNAL_KERNEL_TREE)),"")
  ifeq ($(strip $(CONFIG_KERNEL_GIT_CLONE_URI)),"")
	...
	echo "[Bandrich] Start compile kernel!!!"
	rm -rf $(KERNEL_BUILD_DIR)/linux-2.6.31
	ln -s $(TOPDIR)/linux-2.6.31 $(KERNEL_BUILD_DIR)/linux-2.6.31
...
define Kernel/Prepare/Default
  ...
  define Kernel/Prepare/Default
	...
	svn co $(CONFIG_EXTERNAL_KERNEL_TREE) $(LINUX_DIR)
  endef
endif
